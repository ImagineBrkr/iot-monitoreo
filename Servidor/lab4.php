...
<html lang="en">
  <head>
    ...
    <script>
        ...
        function encender() {
            client.publish('control', 'lab4.start', {qos: 0, retain: false});
            estado = "Encendido"
        }

        function apagar() {
            client.publish('control', 'lab4.stop', {qos: 0, retain: false});
            estado = "Apagado"
        }
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                $sql = "SELECT mensaje, fecha FROM mqtt_mensajes where topic = 'lab4' order by fecha desc limit 10 ";
